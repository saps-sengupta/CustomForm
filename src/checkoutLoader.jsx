...
const CheckoutLoader = ({ cartId, setCartId, setCheckoutid, setFlag, compareConsignments, consignmentUpdateTriggered }) => {
    ...
    // function checkoutKitLoaderModule({ extension, cartId, setCartId, setCheckoutid, setFlag, compareConsignments, consignmentUpdateTriggered }) {
